...
<form class="max-w-sm mx-auto block" action="{{ route('user.auth.login') }}" method="post">
    @csrf
<h1 class="text-lg text-purple-600 m-2 border-b-2 border-purple-400 pb-4 ">ورود به حساب دانش آموزی</h1>
    ...
    <div class="my-4 " id="email">
        <div class="relative">
            ...
            <input type="text" id="email-input" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5   " placeholder="kourosh@gmail.com"  />
    ...
    <div class="my-4 hidden" id="phone">
        <div class="relative">
            ...
            <input type="text" id="phone-input" name="mobile" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  " placeholder="0915123456"  />
    ...
    <input type="submit" name="submit" value="ثبت"  class="text-white w-full submit bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">
